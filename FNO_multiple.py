...
run = Run()
run.init(folder="/FNO_MHD", tags=['FNO', 'MHD', 'JOREK', 'Single-Blob', 'Isothermal', 'MultiVariable', "Skip_Connect", "MinMax-across-vars"], metadata=configuration)
...
for dim in range(num_vars):
    ...
    output_plot.append(file_loc + '/Plots/Isothermal_blob_' + dims[dim] + '_' + run.name + '.png')
