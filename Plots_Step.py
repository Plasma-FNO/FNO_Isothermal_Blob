...
model.load_state_dict(torch.load(file_loc + '/Models/FNO_isothermal_blob_product-major.pth', map_location=torch.device('cpu')))
model.to(device)
...
################################################################
model = FNO_multi(modes, modes, width_vars, width_time)
model.load_state_dict(torch.load(file_loc + '/Models/FNO_isothermal_blob_nondeterministic-epoch.pth', map_location=torch.device('cpu')))
...
plt.savefig("isothermal_blob_error_steps.pdf", bbox_inches='tight')
plt.savefig("isothermal_blob_error_steps.svg", bbox_inches='tight')
 #%% 